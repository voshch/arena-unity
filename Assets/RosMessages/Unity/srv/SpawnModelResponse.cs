...
namespace RosMessageTypes.Unity
{
    ...
    public class SpawnModelResponse : Message
    {
        ...
        public static SpawnModelResponse Deserialize(MessageDeserializer deserializer) => new SpawnModelResponse(deserializer);

        private SpawnModelResponse(MessageDeserializer deserializer)
        {
